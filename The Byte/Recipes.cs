        ...
        public Recipes()
        {
            RecipeList = new List<Recipe>
            {
                new Recipe(1, "Spaghetti Bolognese")
                {
                    ...
                    ImagePath = "../SpaghettiBolognese.png",
                    IsFavourited = false
                },
                ...
                new Recipe (5, "Vegetable Stir-Fry")
                {
                    ...
                    ImagePath = "../../VegetableStirFry.png",
                    IsFavourited = false
                },
                ...
                new Recipe (8, "Vegetable Lasagna")
                {
                    ...
                    ImagePath = "../../VegetableLasagna.png",
                    IsFavourited = false
                },
                new Recipe(11, "Pancakes")
                {
                    ...
                    Instructions ="1. In a large bowl, sift together the flour, baking powder, salt, and sugar.\n" +
                                  ...
                                  "5. Cook until bubbles form on the surface, then flip with a spatula and cook until browned on the other side.\n" +
                                  "6. Serve hot with your favorite toppings such as maple syrup, fresh fruit, or whipped cream.\n",
                    CookTime = TimeSpan.FromMinutes(15),
                    ImagePath = "../../images/Pancakes.png",
                    IsFavourited = false
                }
            };
        }
